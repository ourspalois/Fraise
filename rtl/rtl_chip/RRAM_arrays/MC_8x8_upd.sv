module MC_8x8_FULL_upd (
    ...
    function logic [7:0] elementwise_or_with_x_check(input logic [7:0] a, input logic [7:0] b);
        logic [7:0] result;
    ...
    function logic [7:0] clamp_to_zero(input logic [7:0] a);
        logic [7:0] result;
    ...
    assign DOUT = clamp_to_zero(DOUT_cumulative[7]) ;
